...
const INTENTIONAL_NATIVE_GAPS = new Map([
  ...
  ["CommitInput", "IME composition-safe commit wrapper depends on DOM compositionstart/end events; native TextInput has no equivalent composition-break bug"],
  ["CommitTextarea", "IME composition-safe commit wrapper depends on DOM compositionstart/end events; native TextInput has no equivalent composition-break bug"],
  ["CommitAutoGrowTextarea", "IME composition-safe commit wrapper depends on DOM compositionstart/end events; native TextInput has no equivalent composition-break bug"],
