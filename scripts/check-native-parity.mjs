...
const INTENTIONAL_PROP_GAPS = new Map([
  ...
  ["Calendar", { webOnly: [], nativeOnly: ["value", "onChange", "minDate", "maxDate", "locale", "weekendTone", "todayEmphasis", "disablePast", "today", "defaultMonth", "onMonthChange", "renderDay", "dayAccessibilityLabel", "previousMonthLabel", "nextMonthLabel", "style"], reason: "Web Calendar wraps react-day-picker (props flow through DayPicker's own types, invisible to this own-props extractor); Native declares its own controlled props directly. The day-presentation props (weekendTone/todayEmphasis/disablePast/renderDay/dayAccessibilityLabel, issue #298④) are react-day-picker's modifiers/formatters/components API on Web, so they are inherited there rather than declared" }],
