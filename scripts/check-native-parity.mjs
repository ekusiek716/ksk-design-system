...
const INTENTIONAL_PROP_GAPS = new Map([
  ...
  ["DateField", { webOnly: ["className", "dateFormat"], nativeOnly: ["formatter", "accessibilityLabel"], reason: "dateFormat (format string) vs formatter (function) diverged independently for the same feature; accessibilityLabel/triggerLabel (issue #426) are the same trigger label in platform-native vocabulary" }],
