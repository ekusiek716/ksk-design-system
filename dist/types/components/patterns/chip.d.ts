 ...
 */
declare function Chip({ className, id, style, title, variant, size, shape, href, selected, soldOut, removable, onRemove, count, children, disabled: disabledProp, ...props }: ChipProps): React.JSX.Element;
