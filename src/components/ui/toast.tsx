...
const toastVariants = cva(
  "relative flex w-full items-center gap-3 overflow-hidden rounded-lg border border-[var(--Border-Low-Emphasis)] p-4 shadow-[var(--shadow-lg)] transition-all animate-fade-in-up",
  {
    variants: {
      variant: {
