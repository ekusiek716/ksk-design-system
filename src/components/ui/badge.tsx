...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border border-transparent px-2.5 py-0.5 typo-label-sm w-fit whitespace-nowrap shrink-0 transition-colors",
  {
    variants: {
      variant: {
