...
| ProgressRing | `@/components/ui/progress-ring` | — | Default, Empty, Full, AllSizes, CustomLabel, Animated, 任意サイズ・ストローク, 配色のカスタマイズ, 過大なストロークの丸め, トーン（意味名の色指定）, 線端 |
