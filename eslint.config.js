...
export default tseslint.config(
  ...
  { ignores: ["dist", "storybook-static", "mcp-server/dist", "examples"] },
  {
    ...
    plugins: {
      ...
      "ksk-a11y": kskIconButtonAriaLabel,
    },
    rules: {
      ...
      // アイコンのみボタンの aria-label 欠如検出（A006 / issue #261, #264④）。
      // axe-core（addon-a11y）は Storybook 経由のケースのみ検知するため、
      // 消費側の実装コードも含めて書いた瞬間に検出する静的ガードとして error。
      "ksk-a11y/icon-button-aria-label": "error",
